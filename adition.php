                                ...
                                <div class="card-header">
                                    ...
                                    <div class="card-body">
                                        <form action="bill.php" method="post" >
                                           <input type="hidden" id="company" placeholder="" class="form-control" name="id">

                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Grs no</label>
                                                <input type="text" id="company" placeholder="" class="form-control" name="grsno">
                                            </div>
